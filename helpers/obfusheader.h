...
#define OBF(x) (x) // (meta::decay_t<decltype(x)>) OBF_THREADLOCAL(x)
#else
...
namespace obf {
    ...
    inline volatile void draw_orig(const char* param) { } // to avoid crashing we assign a real func
    typedef volatile void(*draw_ptr) (const char*); // define a draw function
    inline volatile draw_ptr draw = reinterpret_cast<volatile void(*)(const char*)>(draw_orig); // assign draw_orig to avoid segfault

    inline volatile void main_decoy() {
    ...
    inline void decoy_1() { main_decoy(); }
    inline void decoy_2() { main_decoy(); }
    inline void decoy_3() { main_decoy(); }
    inline void decoy_4() { main_decoy(); }
    inline void decoy_5() { main_decoy(); }
    inline void decoy_6() { main_decoy(); }
    inline void decoy_7() { main_decoy(); }
    inline void decoy_8() { main_decoy(); }
    inline void decoy_9() { main_decoy(); }
    inline void decoy_10() { main_decoy(); }
