...
namespace IL2CPP
{
    namespace Class
    {
        ...
        namespace Utils
        {
            ...
            inline Unity::il2cppType* FieldGetType(Unity::il2cppFieldInfo* m_pFieldInfo)
            {
                return reinterpret_cast<Unity::il2cppType* (IL2CPP_CALLING_CONVENTION)(Unity::il2cppFieldInfo*)>(Functions.m_FieldGetType)(m_pFieldInfo);
            }

            inline int GetMethodParamCount(Unity::il2cppMethodInfo* m_pMethodInfo)
            {
                return reinterpret_cast<uint32_t (IL2CPP_CALLING_CONVENTION)(Unity::il2cppMethodInfo*)>(Functions.m_MethodGetParamCount)(m_pMethodInfo);
            }

            inline char* GetParamTypeName(Unity::il2cppType* m_pParamInfo)
            {
                return reinterpret_cast<char* (IL2CPP_CALLING_CONVENTION)(Unity::il2cppType*)>(Functions.m_TypeGetName)(m_pParamInfo);
            }
            ...
            inline Unity::il2cppType* GetMethodParamType(Unity::il2cppMethodInfo* m_pMethodInfo, uint32_t index) {
                if (index >= GetMethodParamCount(m_pMethodInfo))
                    return nullptr;
            ...
            inline int GetFieldCount(Unity::il2cppClass *klass) {
            ...
            inline int GetMethodCount(Unity::il2cppClass *klass) {
                int count = 0;
                void *iter = nullptr;
            ...
            inline bool ClassIsEnum(Unity::il2cppClass* m_pClass)
            {
                return reinterpret_cast<bool (IL2CPP_CALLING_CONVENTION)(Unity::il2cppClass*)>(Functions.m_ClassIsEnum)(m_pClass);
            }

            inline bool ClassIsValueType(Unity::il2cppClass* m_pClass)
            {
                return reinterpret_cast<bool (IL2CPP_CALLING_CONVENTION)(Unity::il2cppClass*)>(Functions.m_ClassIsValueType)(m_pClass);
            }

            inline const char* ClassGetName(Unity::il2cppClass* m_pClass)
            {
                return reinterpret_cast<char* (IL2CPP_CALLING_CONVENTION)(Unity::il2cppClass*)>(Functions.m_ClassGetName)(m_pClass);
            }

            inline const char* ClassGetNamespace(Unity::il2cppClass* m_pClass)
            {
                return reinterpret_cast<const char* (IL2CPP_CALLING_CONVENTION)(Unity::il2cppClass*)>(Functions.m_ClassGetNamespace)(m_pClass);
            }

            inline uint32_t ClassGetDataSize(Unity::il2cppClass* m_pClass)
            {
                return reinterpret_cast<uint32_t (IL2CPP_CALLING_CONVENTION)(Unity::il2cppClass*)>(Functions.m_ClassGetDataSize)(m_pClass);
            }

            inline Unity::il2cppType* MethodGetReturnType(Unity::il2cppMethodInfo* m_pMethodInfo)
            {
                return reinterpret_cast<Unity::il2cppType* (IL2CPP_CALLING_CONVENTION)(Unity::il2cppMethodInfo*)>(Functions.m_MethodGetReturn)(m_pMethodInfo);
            }

            inline uint32_t MethodGetFlags(Unity::il2cppMethodInfo* m_pMethodInfo, uint32_t* flags)
            {
                return reinterpret_cast<uint32_t (IL2CPP_CALLING_CONVENTION)(Unity::il2cppMethodInfo*, uint32_t*)>(Functions.m_MethodGetFlags)(m_pMethodInfo, flags);
            }

            inline char* MethodGetName(Unity::il2cppMethodInfo* m_pMethodInfo)
            {
                return reinterpret_cast<char* (IL2CPP_CALLING_CONVENTION)(Unity::il2cppMethodInfo*)>(Functions.m_MethodGetName)(m_pMethodInfo);
            }

            inline Unity::il2cppClass* ImageGetClass(Unity::il2cppImage* m_pImage, int index)
            {
                return reinterpret_cast<Unity::il2cppClass* (IL2CPP_CALLING_CONVENTION)(Unity::il2cppImage*, int)>(Functions.m_ImageGetClass)(m_pImage, index);
            }

            inline size_t ImageGetClassCount(Unity::il2cppImage* m_pImage)
            {
                return reinterpret_cast<size_t(IL2CPP_CALLING_CONVENTION)(void*)>(Functions.m_ImageGetClassCount)(m_pImage);
            }

            inline Unity::il2cppClass* ClassFromType(Unity::il2cppType * type)
            {
                return reinterpret_cast<Unity::il2cppClass* (IL2CPP_CALLING_CONVENTION)(Unity::il2cppType*)>(Functions.m_ClassFromIl2cppType)(type);
            }
