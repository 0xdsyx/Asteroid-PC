...
namespace IL2CPP
{
	...
	struct Functions_t
	{
		...
		void* m_ClassFromType = nullptr;

		void* m_MethodGetParamCount = nullptr;
		void* m_TypeGetName = nullptr;
		void* m_MethodGetReturn = nullptr;
		void* m_ClassGetName = nullptr;
		void* m_MethodGetFlags = nullptr;
		void* m_MethodGetName = nullptr;
		void* m_ClassIsEnum = nullptr;
		void* m_ClassIsValueType = nullptr;
		void* m_ClassGetDataSize = nullptr;
		void* m_ClassGetNamespace = nullptr;
		void* m_ImageGetClasses = nullptr;
		void* m_FieldGetType = nullptr;
	};
