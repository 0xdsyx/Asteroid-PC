	...
	namespace UnityAPI
	{
		...
		inline bool Initialize()
		{
			...
			std::unordered_map<std::string, void**> m_ExportMap =
			{
				...
				{ IL2CPP_CLASS_FROM_TYPE,							&Functions.m_ClassFromType },
				{ IL2CPP_METHOD_GET_PARAM_COUNT,                    &Functions.m_MethodGetParamCount},
				{ IL2CPP_TYPE_GET_NAME,                             &Functions.m_TypeGetName},
				{ IL2CPP_METHOD_GET_RETURN_TYPE,                    &Functions.m_MethodGetReturn},
				{ IL2CPP_CLASS_GET_NAME,                            &Functions.m_ClassGetName},
				{ IL2CPP_METHOD_GET_FLAGS,                          &Functions.m_MethodGetFlags},
				{ IL2CPP_METHOD_GET_NAME,                           &Functions.m_MethodGetName},
				{ IL2CPP_CLASS_IS_ENUM,                             &Functions.m_ClassIsEnum},
				{ IL2CPP_CLASS_IS_VALUETYPE,                        &Functions.m_ClassIsValueType},
				{ IL2CPP_CLASS_GET_DATA_SIZE,                       &Functions.m_ClassGetDataSize},
				{ IL2CPP_CLASS_GET_NAMESPACE,                       &Functions.m_ClassGetNamespace},
				{ IL2CPP_IMAGE_GET_CLASS,                           &Functions.m_ImageGetClass},
				{ IL2CPP_FIELD_GET_TYPE,                            &Functions.m_FieldGetType},
			};
