...
namespace ImGui
{
    ...
    // freakdisdude
    IMGUI_API void          StyleColorsAsteroid(ImGuiStyle* dst = NULL);    // new, recommended style (default)
    ...
    // craze was here
    IMGUI_API void          HoverItemText(const char* text, const char* fmt = "(?)");
    ...
    // craze was here
    IMGUI_API bool          CustomBeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags = 0);

    IMGUI_API void          EndCombo(); // only call EndCombo() if BeginCombo() returns true!
    IMGUI_API bool          Combo(const char* label, int* current_item, const char* const items[], int items_count, int popup_max_height_in_items = -1);

    // craze was here
    IMGUI_API bool          CustomCombo(const char* label, int* current_item, const char* const items[], int items_count, int height_in_items = -1);
    ...
    // craze was here
    IMGUI_API bool          CustomCombo(const char* label, int* current_item, const char* (*getter)(void* user_data, int idx), void* user_data, int items_count, int popup_max_height_in_items = -1);
    ...
    // craze was here
    IMGUI_API bool          CustomInputText(const char* label, const char* hint, float posX, float posY, float sizeX, static char buf[], size_t buf_size, ImGuiInputTextFlags flag);
    ...
    // craze was here
    IMGUI_API bool          CustomTab(const char* name, float posX, float posY, bool boolean);
